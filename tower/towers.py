...
RAPID_TEST_IMAGE = pygame.transform.scale(pygame.image.load(
    os.path.join("images", "rapid_test.png")), (70, 70))
PCR_IMAGE = pygame.transform.scale(pygame.image.load(
    os.path.join("images", "pcr.png")), (70, 70))
ALCOHOL_IMAGE = pygame.transform.scale(pygame.image.load(
    os.path.join("images", "alcohol.png")), (25, 70))
PLOT_IMAGE = pygame.transform.scale(pygame.image.load(
    os.path.join("images", "vacant_lot.png")), (20, 20))
...
class Tower:
    ...
    def __init__(self, x: int, y: int, attack_strategy, image):
        ...
        # chose an attack strategy (AOE, single attack ....)
    ...
    def attack(self, enemy_group: list):
        ...
        self.cd_count = self.attack_strategy.attack(
            enemy_group, self, self.cd_count)
